...
class coaffinityattention(nn.Module):
    ...
    def forward(self, feature1, feature2):
        ...
        feature1ca=feature1ca.view(-1, feature1ca.size()[1], feature1ca.size()[2]*feature1ca.size()[3])
        feature2ca=feature2ca.view(-1, feature2ca.size()[1], feature2ca.size()[2]*feature2ca.size()[3])
        #计算两个特征图的相关性
        A2=torch.bmm(feature1ca, torch.transpose(feature2ca,1,2).contiguous())
        
        A = F.softmax(A2, dim = 1)
        # print(A.size())
        # print(feature1.size())
        feature1view=feature1.view(-1, feature1.size()[1], feature1.size()[2]*feature1.size()[3])
...
class Decoder(nn.Module):
    ...
    def forward(self, res1, res2, res3, res4, h, w):
        ...
        y3=self.coaffinityat(y3.softmax(dim=1),x.softmax(dim=1))
        ...
        y4=self.coaffinityat(y4.softmax(dim=1),x.softmax(dim=1))
