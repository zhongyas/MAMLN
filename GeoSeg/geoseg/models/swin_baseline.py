...
class DCFAM(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4):
        ...
        out4 = self.conv_4(x4) #[4, 768, 32, 32]

        # print('out4:', out4.shape)

        # print('out4:', out4.shape)#[4, 768, 32, 32]
        out3 = self.conv_3(x3) #[4, 384, 64, 64]
        # out3 = self.maxpool(self.maxpool(concat2))
        out2 = self.conv_2(x2) #[4, 192, 128, 128]
...
class Decoder(nn.Module):
    ...
    def forward(self,x1, x2, x3, x4):
        out1, out2, out3, out4 = self.dcfam(x1, x2, x3, x4)
...
#'pretrain_weights/swin_base_patch4_window7_224_22k.pth'
def dcswin_base(pretrained=True, num_classes=6, weight_path='pretrain_weights/stseg_base.pth'):
