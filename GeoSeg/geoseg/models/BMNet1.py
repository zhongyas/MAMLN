...
class DCFAM(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4):
        ...
        out4 = self.conv4(x4) + self.down34(self.pa(self.down232(x2))) + concat5
        # print('out4:', out4.shape)

        # print('out4:', out4.shape)#[4, 768, 32, 32]
        out3 = self.pa(x3) + self.down231(self.ca(self.down12(x1))) + concat4

        out2 = self.ca(x2) + self.lf4(out4) + concat3

        del out4
        out1 = self.lf3(out3) + self.conv1(x1) + concat2#[4, 96, 256, 256]
