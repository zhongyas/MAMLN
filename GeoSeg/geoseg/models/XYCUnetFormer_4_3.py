...
def get_incoherent_mask(input_masks, sfact):
    ...
    mask_uncertain[mask_uncertain >= 0.04] = 1.
...
class Decoder(nn.Module):
    def __init__(self,
        ...
        self.convbn=ConvBN(in_channels=decode_channels, out_channels=decode_channels, kernel_size=3,stride=1)
        #双线性插值
