...
class SE(nn.Module):
    ...
    def forward(self, x):
        ...
        concat3 = torch.cat((swin_input_3_refine, swin_input_3_refine, swin_input_3_refine), dim=1)  # 256+256+256==768
        ...
        concat2 = torch.cat((swin_input_2_refine, swin_input_2_refine, swin_input_2_refine), dim=1)  # 128+128+128=384
        ...
        concat1 = torch.cat((swin_input_1_refine, swin_input_1_refine, swin_input_1_refine), dim=1)  # 64+64+64=192
        ...
        x7 = self.avg_pool(concat2)
        x8 = self.avg_pool(concat3)
...
class DCFAM(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4, x5, x6, x7, x8):
        ...
        out4 = self.conv_4(x4) + self.cla(x8) #[4, 768, 32, 32]

        # print('out4:', out4.shape)

        # print('out4:', out4.shape)#[4, 768, 32, 32]
        out3 = self.conv_3(x3) + self.cla(x7) #[4, 384, 64, 64]
        # out3 = self.maxpool(self.maxpool(concat2))
        out2 = self.conv_2(x2) + self.cla(x6) #[4, 192, 128, 128]
        # out2 = self.maxpool(self.maxpool(concat1))

        out1 = self.conv_1(x1)#[4, 96, 256, 256]
