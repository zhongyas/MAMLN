...
#                 # 定义卷积层，卷积核大小为1，padding为0，bias=True
...
class Decoder(nn.Module):
    def __init__(self,
        ...
        self.affinityattention=affinityattention()
    ...
    def forward(self, res1, res2, res3, res4, h, w):
        ...
        #y1和xconcat
        y1=self.affinityattention(y1.softmax(dim=1),x.softmax(dim=1))
        # print("y1:",y1.size())
        ...
        y2=self.affinityattention(y2.softmax(dim=1),x.softmax(dim=1))
        ...
        y3=self.affinityattention(y3.softmax(dim=1),x.softmax(dim=1))
        ...
        # y4=self.affinityattention(y4.softmax(dim=1),x.softmax(dim=1))
