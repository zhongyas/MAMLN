...
class Decoder(nn.Module):
    ...
    def forward(self, res1, res2, res3, res4, h, w):
        ...
        x=self.ppm(res4)#torch.Size([4, 1024, 16, 16])


        
        '''
        x=self.pre_conv(x)#torch.Size([4, 256, 16, 16])
...
'''
        ...
        # print("y.shape=",y.shape)#y.shape= torch.Size([4, 1024, 16, 16])
        x=self.pp4(x,y)
        # print("x2.shape=",x.shape)#x2.shape= torch.Size([4, 1024, 16, 16])
        x = self.pre_conv(x)
        # print("x3.shape=",x.shape)#x3.shape= torch.Size([4, 256, 32, 32])
        x = self.b4(x)
        # print("x4.shape=",x.shape)#x4.shape= torch.Size([4, 256, 32, 32])
        x = self.p3(x, res3)
        # print("p3=",x.shape)#p3= torch.Size([4, 256, 64, 64])
        x=self.pre_conv1(x)
