...
class DCFAM(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4):
        ...
        out4 = self.conv_4(x4) + self.down34(self.down232(x2))   # [4, 768, 32, 32]

        # print('out4:', out4.shape)

        # print('out4:', out4.shape)#[4, 768, 32, 32]
        out3 = self.conv_3(x3) + self.down231(self.down12(x1)) # [4, 384, 64, 64]
        # out3 = self.maxpool(self.maxpool(concat2))
        out2 = self.conv_2(x2) + self.lf4(out4) # [4, 192, 128, 128]
