...
class Decoder(nn.Module):
    ...
    def forward(self, res1, res2, res3, res4, h, w):
        ...
        #
        # res_out=self.res_out_relu(self.res_out)
        # weight=res_out/(torch.sum(res_out,dim=0)+self.epsilon)
        # res1_w4_out=weight[0]*y_res1+weight[1]*res1_w4_out
...
def ft_unetformer_small(pretrained=True, num_classes=6, freeze_stages=-1, decoder_channels=256,
...
def ft_unetformer_tiny(pretrained=True, num_classes=6, freeze_stages=-1, decoder_channels=256,
