...
class Decoder(nn.Module):
    ...
    def forward(self, res1, res2, res3, res4, h, w):
        ...
        # print("res1_out1:",res1_out.shape)
        # res1_out=self.b1_2(res1_out)
        # print("res1_out2:",res1_out.shape)
        ...
        res2_out=res2_out+weight[2]*self.res_down_sample(res1_out)
        ...
        res3_out=res3_out+weight[2]*self.res_down_sample(res2_out)
